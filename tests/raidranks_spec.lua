...
for bossId, rank in pairs(expectedRank) do
    local ilvl, trackKey, actualRank = Where2GoRaidRanks.GetRaidIlvl(bossId)
...
-- MYTH_FINAL_BOSS_IDS).
local coiledAltarIlvl, coiledAltarTrackKey, coiledAltarRank = Where2GoRaidRanks.GetRaidIlvl(2883)
...
local ulatekIlvl, ulatekTrackKey, ulatekRank = Where2GoRaidRanks.GetRaidIlvl(2895)
...
local ilvl, trackKey, rank = Where2GoRaidRanks.GetRaidIlvl(2849)
