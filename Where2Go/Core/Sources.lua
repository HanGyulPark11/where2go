-- Real per-dungeon/per-boss gear item pools for Season 2 (Midnight patch 12.1),
-- generated from Battle.net Game Data API Journal endpoints with
-- non-gear and cosmetic rewards filtered out. See
...
Where2GoSources.DUNGEONS = {
    {
        ...
        encounters = {
            ...
            { bossId = 2880, name = "Zul'jan", itemIds = { 273792, 273797, 273773, 273791, 273789, 273776, 273778, 273784, 275070 } },
        },
    },
    {
        instanceId = 1311,
        ...
        encounters = {
            ...
            { bossId = 2778, name = "Nalorakk", itemIds = { 256737, 251160, 250229, 251159, 251158, 251156, 251173, 251214, 251173 } },
        },
    },
    {
        instanceId = 1304,
        ...
        encounters = {
            ...
            { bossId = 2682, name = "Lithiel Cinderfury", itemIds = { 250255, 251142, 251139, 251140, 251141, 251138, 258045 } },
        },
    },
    {
        instanceId = 1309,
    ...
    },
    {
        ...
        encounters = {
            ...
            { bossId = 2172, name = "Dazar, The First King", itemIds = { 159645, 159301, 159644, 239047, 239045, 239048, 239046, 239049, 239050, 239051, 239045, 239047, 239050, 239051, 239046, 239048, 239049, 273649 } },
        },
    },
    {
        instanceId = 1202,
        ...
        encounters = {
            ...
            { bossId = 2503, name = "Kyrakka and Erkhart Stormvein", itemIds = { 193756, 193752, 193691, 193750, 193754, 193755, 193751, 193748, 193753 } },
        },
    },
    {
        instanceId = 1030,
        ...
        encounters = {
            ...
            { bossId = 2145, name = "Avatar of Sethraliss", itemIds = { 159374, 158373, 159254, 159318, 158368, 159370, 159424, 159337, 159257, 159439, 159374, 159254, 159318, 159370, 159424, 159257, 159439 } },
        },
    },
}
...
Where2GoSources.RAIDS = {
    {
        ...
        encounters = {
            { bossId = 2849, name = "Nymrissa Wavecaller", itemIds = { 270167, 268199, 268221, 268238, 268226, 268263, 268262, 268232, 268247, 268217, 268244, 268266 } },
        },
    },
    {
        instanceId = 1320,
        ...
        encounters = {
            { bossId = 2888, name = "Nek'zali the Soulcoiler", itemIds = { 268230, 270162, 268203, 268236, 268235, 268229, 268245, 268208, 270930, 268248, 268218, 268240, 268216 } },
            ...
            { bossId = 2894, name = "The Lost Explorers", itemIds = { 270925, 270924, 270923, 270922, 270164, 270160, 268210, 268200, 268227, 268242, 268258, 268239, 268196 } },
            ...
            { bossId = 2887, name = "The Twin Fangs", itemIds = { 270917, 270916, 270915, 270914, 270171, 270170, 268251, 268264, 268241, 268261, 268223, 268220, 273070 } },
            { bossId = 2883, name = "The Coiled Altar", itemIds = { 268225, 268231, 268209, 270173, 268243, 270169, 268237, 268222, 268213, 268253, 268255, 268256, 268259, 268211 } },
            { bossId = 2895, name = "Ula'tek", itemIds = { 270909, 268202, 268215, 270168, 270175, 268207, 268265, 271874, 271875, 271876, 271878, 271093, 271092 } },
        },
    },
}
